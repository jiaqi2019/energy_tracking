...
let expiredInfo = uni.getStorageSync('uni_id_token_expired') || {};
console.log('expiredInfo', expiredInfo);
const data = {
  userInfo: hostUserInfo,
  hasLogin: Object.keys(hostUserInfo).length != 0,
  isExpired: Date.now() > expiredInfo,
};
...
export const mutations = {
  ...
  loginBack (e = {}) {
    ...
    if (delta) {
      ...
      return uni.reLaunch({ url: `/${page.path}` });
    }
